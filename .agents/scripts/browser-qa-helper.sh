...
_generate_stability_script() {
	...
	sed "s|\${safe_url}|${safe_url}|g; \
	     s|\${pages_array}|${pages_array}|g; \
	     s|\${reloads}|${reloads}|g; \
	     s|\${timeout}|${timeout}|g; \
	     s|\${poll_interval}|${poll_interval}|g; \
	     s|\${poll_max_wait}|${poll_max_wait}|g" \
		"$SCRIPT_DIR/browser-qa-stability.js.template" >"$script_file"
